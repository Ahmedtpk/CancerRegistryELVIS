...
const VariableDetails: React.FC = () => {
  ...
  return (
    <div className="flex bg-white w-screen h-full min-h-screen pt-16">
      <div className="flex w-full justify-center p-4 border border-red-600">
        <div className='flex w-full xl:w-1/3 lg:w-fit border border-black shadow-lg h-fit p-4 rounded-lg shadow-[#46658D] flex-col'>
          <p className='text-2xl font-semibold'>Hei Og velkommen til min case oppgave for FHI/Kreftregisteret </p>
          <p className='text-xl font-semibold text-[#46658A] mt-7' >I denne applikasjonen har du mulighet til å se variabler som Kreftregisteret har forhåndsdefinert. Denne siden er en tilnærmet versjon av den opprinnelige nettsiden, som du kan finne <a className='text-purple-500 border-b border-black' href='https://metadata.kreftregisteret.no'>her</a>. Selv om det er noe funksjonalitet som mangler, kan dette ordnes ved behov.</p>
